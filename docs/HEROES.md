...
*Измерение: Сильванис. Хранительница леса, не промахивается по тому, кого видит.*
...
*Измерение: Ферритум. Последний защитник павшей крепости.*
...
*Измерение: Умбра. Ассасин, двигается между тенями.*
...
*Измерение: Нексус. Оперативник разведки, знание — её оружие.*
...
*Измерение: Аркана. Манипулирует тканью реальности.*
...
*Измерение: Хаотикум. Единственный, кто считает взрывы весёлыми.*
...
*Измерение: Люминис. Паладин-защитник, щит непробиваем.*
...
*Измерение: Лимбо. Не жив и не мёртв, существует в щелях реальности.*
...
*Измерение: Механикус. Собирает устройства из всего, дрон Спарки — лучший друг.*
- Steps: 4 | Range: 5 | CD: 2 | Armor: 0 | Speed: 1
...
*Измерение: Примордис. Вождь племени, решает всё кулаками.*
...
*Измерение: Стиллнесс. Снайпер, ждёт часами ради одного идеального выстрела.*
...
*Измерение: Рефлектум. Никто не знает, какой настоящий.*
- Steps: 5 | Range: 4 | CD: 1 | Armor: 0 | Speed: 1
